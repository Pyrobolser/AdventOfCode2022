...
WriteLine("                 =>+-+>   Day 6   <+-+<=                 ");
WriteLine("          >-=>>+-+>   Tuning Trouble   <+-+<<=-<         ");
WriteLine($"+> Part 1: {Day6.Run(4)} characters need to be processed before the first start-of-packet marker");
WriteLine($"+> Part 2: {Day6.Run(14)} characters need to be processed before the first start-of-message marker");